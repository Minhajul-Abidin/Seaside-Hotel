    ...
    <footer className="bg-[#032B22] text-[#EFEDE7] py-10">
        <div className="container mx-auto flex flex-wrap justify-between items-start">
            <div className="w-full lg:w-1/3 mb-6 lg:mb-0 text-center lg:text-left">
                <h2 className="text-xl mb-4  text-center font-LakesNeueRegular">RESERVATIONS OFFICE</h2>
                <p className=" text-center font-TypewcondRegular">123 Anywhere St.,<br />Any City ST 12345</p>
                <p className="mt-4  text-center font-TypewcondRegular">123-456-7890<br />saadkhan108b@gmail.com</p>
            </div>
            <div className="w-full lg:w-1/3 mb-6 lg:mb-0 text-center lg:text-left">
        ...
        <div className="container mx-auto mt-40 text-center">
            <h1 className="text-4xl md:text-7xl lg:text-9xl font-bold text-[#40FFB5] font-CinzelRegular ">SEASIDE HOTEL</h1>
        </div>
    </footer>
  );
}
