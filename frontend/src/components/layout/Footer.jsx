    ...
    <footer className="bg-[#032B22] text-[#EFEDE7] py-10">
      <div className="container mx-auto flex flex-wrap justify-between items-start">
        <div className="w-full lg:w-1/3 mb-6 lg:mb-0 text-center lg:text-left">
          <h2 className="text-xl mb-4  text-center font-LakesNeueRegular">
            RESERVATIONS OFFICE
          </h2>
          <p className=" text-center font-TypewcondRegular">
            123 Anywhere St.,
            <br />
            Any City ST 12345
          </p>
          <p className="mt-4  text-center font-TypewcondRegular">
            123-456-7890
            <br />
        ...
        <div className="w-full lg:w-1/3 mb-6 lg:mb-0 text-center lg:text-left">
          <h3 className="text-xl mb-4 font-LakesNeueRegular text-center">
            OFFICE HOURS
          </h3>
          <p className="text-center font-TypewcondRegular">
            MONDAY TO FRIDAY
        ...
        <div className="w-full lg:w-1/3 flex justify-center lg:justify-end space-x-4">
          <a
            href="https://www.linkedin.com/in/saad-khan-aa8035258/"
            target="_blank"
          >
            <svg
              fill="#EFEDE7"
            ...
            >
              <g id="social-linkedin">
                <path
                  d="M22.2,0H1.8C0.8,0,0,0.8,0,1.8v20.5c0,1,0.8,1.8,1.8,1.8h20.5c1,0,1.8-0.8,1.8-1.8V1.8C24,0.8,23.2,0,22.2,0z M7.2,20.4
      ...
      <div className="container mx-auto mt-40 text-center">
        <h1 className="text-4xl md:text-7xl lg:text-9xl font-bold text-[#40FFB5] font-CinzelRegular ">
          SEASIDE HOTEL
        </h1>
      </div>
    </footer>
